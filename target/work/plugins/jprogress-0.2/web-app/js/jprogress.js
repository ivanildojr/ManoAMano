...
function showProgressBar(progressId, infoId, infoMessage, updateUrl, updateInterval, progressTargetSelector,closureComplete) {
    ...
    var complete = "<div class='ui-state-highlight ui-corner-all'>Processamento encerrado!</div>"+
    				"<br><a href=\"/ManoAMano/relatorio/principal\">P&aacute;gina de Relat&oacute;rios</a>";
